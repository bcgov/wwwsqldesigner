...
SQL.IO.prototype.clientsql = function () {
    ...
    this.dom.status.textContent = "Server-side export is available from the exact version view in Account and settings.";
};

SQL.IO.prototype.getExportTarget = function () {
    return this.dom.exporttarget ? this.dom.exporttarget.value : "";
};
