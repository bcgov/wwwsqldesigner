...
SQL.PortableTypes = {
    ...
    sourceAdapters: {
        ...
        oracle: { number:"decimal", numeric:"decimal", decimal:"decimal", integer:"integer", int:"integer", smallint:"integer", float:"float", binary_float:"float", binary_double:"float", varchar2:"string", nvarchar2:"string", char:"string", nchar:"string", clob:"text", nclob:"text", blob:"binary", raw:"binary", date:"datetime", timestamp:"datetime", "timestamp with time zone":"datetime-with-time-zone", boolean:"boolean", xmltype:"xml", json:"json" },
        cubrid: { short:"integer", smallint:"integer", integer:"integer", bigint:"integer", numeric:"decimal", decimal:"decimal", float:"float", double:"float", char:"string", varchar:"string", string:"string", nchar:"string", "nchar varying":"string", date:"date", time:"time", timestamp:"datetime", datetime:"datetime", bit:"binary", "bit varying":"binary", blob:"binary", clob:"text" },
        vfp9: { character:"string", varchar:"string", memo:"text", integer:"integer", numeric:"decimal", float:"float", double:"float", logical:"boolean", date:"date", datetime:"datetime", blob:"binary", varbinary:"binary" },
        sqlalchemy: { "sa.integer":"integer", "sa.biginteger":"integer", "sa.numeric":"decimal", "sa.float":"float", "sa.string":"string", "sa.text":"text", "sa.boolean":"boolean", "sa.date":"date", "sa.time":"time", "sa.datetime":"datetime", "sa.timestamp":"datetime", "sa.binary":"binary", "sa.largebinary":"binary", "sa.uuid":"uuid", "sa.json":"json" },
        web2py: { string:"string", text:"text", integer:"integer", double:"float", decimal:"decimal", boolean:"boolean", date:"date", time:"time", datetime:"datetime", blob:"binary", upload:"string", reference:"integer", id:"integer" }
    },
    targetAdapters: {
